...
moduleExports.webpackConfigDir = path.resolve(moduleExports.staticRootDir, './webpack-config'); // webpack配置文件所在目录
...
moduleExports.metronicDir = path.resolve(moduleExports.publicDir, './metronic');  // 使用的基于bootstrap的一套框架库
